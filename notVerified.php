...
if ($_GET) {
    ...
    sendVerificationMail($_SESSION['email'], $_SESSION['token']);
}
...
<html lang="en">
    <head>
        ...
        <title>My Secret Diary - Not Verified</title>
    ...
    <body>
        ...
        <div class="container-fluid" id="background">
            ...
            <div class="alert alert-danger text-center" role="alert">
                ...
                <br>
                <p>If you did not receive the e-mail, please <a id="reMail" href='?submitted=yes'>click here</a> and we will re-send it to you. </p>
